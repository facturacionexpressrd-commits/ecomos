 ...
 */
export async function getVariantRefunds(prisma: PrismaClient, variantId: string): Promise<number> {
 ...
 */
export async function getStoreRefunds(prisma: PrismaClient, storeId: string): Promise<number> {
